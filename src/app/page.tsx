...
export default function Home() {
  ...
  const [isDarkModeForced, setIsDarkModeForced] = useState<boolean | null>(null)
  ...
  useEffect(() => {
    const handleMessage = (event: MessageEvent) => {
      ...
      if (event.data && event.data.type === 'THEME_CHANGE') {
        ...
        console.log(`🎨 Dashboard switching to ${isDark ? 'dark' : 'light'} mode`);
        
        setIsDarkModeForced(isDark)
    ...
    console.log('🎧 Dashboard postMessage listener registered');
